...
function HomeCopy() {
  ...
  return (
    <>
      ...
      <div className="card col-6 mx-auto my-5 bg-dark">
      <input type="text" name="" className="form-control" onChange={(e) => onChange(e.target.value)} id="" placeholder="pin" />

<input type="text" className="form-control" placeholder="city" value={address.city}></input>
      </div>
      ...
      <section>
        <div className="container py-4">
          <div className="row gy-4">
            <div className="col-12 section-heading text-center">
              <h2 className="h1">Our Categories</h2>
            </div>
            <div className="col-12 pt-0 mx-auto text-center">
              <div className="img-holder">
                <img
